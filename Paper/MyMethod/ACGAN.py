...
def plt_loss_and_acc(total_batch:int,dloos,gloos,acclist):
    import matplotlib.pyplot as plt
    batches=range(0,total_batch)
    plt.plot(batches, acclist, color='r', label='acc')  # r表示红色
    plt.plot(batches, dloos, color='b', label='dloss')  # 也可以用RGB值表示颜色
    plt.plot(batches, gloos, color='g', label='gloss')  # 也可以用RGB值表示颜色
...
plt_loss_and_acc(opt.n_epochs,dlossList,gLossList,accList)