...
feature_num=54
_min = [1e9 + 1] * feature_num
_max = [0.0] * feature_num
...
if __name__ == '__main__':
    pkt_length_seq = [383, -290, 90, -165, 1448, 463, 929, 389, 1448, 976, 1448, 1448, 1448, 1448, 1448, 1448, 1448,
                      1448, 1448, 1448, 1448, 1448, 1448, 717, 105, 1448, 1448, 1448, 1448, 1051, 144, 219, 196, 603,
                      113,100,100,-100]
